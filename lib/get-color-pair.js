...
// Currently hard-coding the o-colors values
// We should use o-colors values directly when that is possible.
// Currently waiting on https://github.com/Financial-Times/o-colors/issues/289
const colors = {
	black: '#000000',
	white: '#ffffff',
	paper: '#fff1e5',
