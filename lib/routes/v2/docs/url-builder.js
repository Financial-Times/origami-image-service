...
module.exports = app => {
	...
	// v2 url-builder page
	app.get('/__origami/service/image/v2/docs/url-builder', cacheControl({maxAge: '7d'}), (request, response) => {
		...
		const demo = {
			...
			head: buildDemoUrl('fthead-v1:roula-khalaf'),
			...
			specialisttitle: buildDemoUrl('specialisttitle-v1:board-director-programme'),
			['app-badge']: buildDemoUrl('app-badge-v1:apple')
		};
