...
module.exports = app => {
	...
	app.get(/^\/__origami\/service\/image\/v2\/images\/(raw|debug|metadata|purge|placeholder)\/((ftflag|fticon|ftsocial|ftlogo|ftbrand|ftpodcast|specialisttitle)(-v\d+)?(:|%3A).*)$/i,
		mapParams,
		mapScheme,
		mapCustomScheme(app.ft.options),
		requireValidSourceParam,
	...
	app.get('/__origami/service/image/v2/imagesets/:scheme(ftbrand|ftbrand-v1|ftflag|ftflag-v1|fticon|fticon-v1|ftlogo|ftlogo-v1|ftpodcast|ftpodcast-v1|ftsocial|ftsocial-v1|ftsocial-v2|specialisttitle|specialisttitle-v1)',
		(request, response) => {
