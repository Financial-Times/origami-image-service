...
module.exports = app => {
	...
	app.get('/__origami/service/image/v2/imagesets/:scheme(ftbrand|ftbrand-v1|app-badge|ftflag|ftflag-v1|fticon|fticon-v1|ftlogo|ftlogo-v1|ftpodcast|ftpodcast-v1|ftsocial|ftsocial-v1|ftsocial-v2|specialisttitle|specialisttitle-v1)',
		(request, response) => {
