...
module.exports = app => {
	...
	app.get(
		/^\/v2\/images\/(raw|debug|metadata|purge|placeholder)\/((ftflag|fticon|ftsocial|ftpodcast|ftlogo|ftbrand|specialisttitle)(-v\d+)?(:|%3A).*)$/i,
		mapParams,
		mapScheme,
		mapCustomScheme(app.ft.options),
		requireValidSourceParam,
	...
	// ftflag
	// app.get(
	// 	'/internal-images/brand-images/*',
	// 	st({ path: path.join(__dirname, '../../../image-sets/ftbrand'), url: '/internal-images/brand-images' })
	// );
	// fthead
	// app.get(
	// 	'/internal-images/brand-images/*',
