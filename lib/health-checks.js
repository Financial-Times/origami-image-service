		...
		checks: [
			...
			// on a non-200 response
			{
				...
				url: () => {
					...
					return cloudinary.url(`${options.customSchemeStore}/internal-images/1x1.gif?cachebust=${cacheBust}`, {type: 'fetch'});
				},
				interval: 60000,
			...
			// response
			{
				...
				url: () => {
					...
					return `${customSchemeBaseUrl}/internal-images/fticon/v1/cross.svg`;
				},
				interval: 30000,
