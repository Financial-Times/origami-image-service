...
function cloudinaryTransform(transform, options = {}) {
	...
	const cloudinaryUrl = cloudinary.url(transform.getName()||encodeURI(transform.getUri()), buildCloudinaryTransforms(transform));
	return cloudinaryUrl.replace(
		'res.cloudinary.com',
		`${process.env.CLOUDINARY_SUBDOMAIN || 'res'}.cloudinary.com`
	);
}
