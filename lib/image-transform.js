...
module.exports = class ImageTransform {
	...
	constructor(properties) {
		...
		this.setWidth(properties.width, properties.dpr);
		this.setHeight(properties.height, properties.dpr);
	...
	setWidth(value, dpr) {
		...
		if (this.width && dpr > 1) this.width = this.width / dpr;
	}
	...
	setHeight(value, dpr) {
		...
		if (this.height && dpr > 1) this.height = this.height / dpr;
	}
