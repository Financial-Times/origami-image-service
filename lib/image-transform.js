...
module.exports = class ImageTransform {
	...
	static resolveCustomSchemeUri(uri, baseUrl, cacheBust) {
		...
		switch (scheme) {
			...
			// For custom schemes with image sets, we build the
			// expected URL. This directory structure comes from:
			// https://github.com/Financial-Times/origami-image-set-tools
			case 'fticon':
			case 'ftlogo':
			case 'ftsocial':
