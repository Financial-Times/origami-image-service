			...
			case 'ftflag':
				{
					switch (version) {
						case 'v1':
							{
								if (flagImages[pathname]) {
									return flagImages[pathname] + (path.extname(pathname) ? '' : '.svg' ) + queryString;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
			...
			case 'fticon':
				{
					switch (version) {
						case 'v1':
							{
								if (ftIcons[pathname]) {
									return ftIcons[pathname] + (path.extname(pathname) ? '' : '.svg' ) + queryString;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
			...
			case 'ftlogo':
				{
					switch (version) {
						case 'v1':
							{
								if (logoImages[pathname]) {
									return logoImages[pathname] + (path.extname(pathname) ? '' : '.svg' ) + queryString;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
			...
			case 'ftsocial':
				{
					switch (version) {
						case 'v1':
							{
								if (socialImages[pathname]) {
									return socialImages[pathname] + (path.extname(pathname) ? '' : '.svg' ) + queryString;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
			...
			case 'specialisttitle':
				{
					switch (version) {
						case 'v1':
							{
								if (specialistTitleLogos[pathname]) {
									return specialistTitleLogos[pathname] + (path.extname(pathname) ? '' : '.svg' ) + queryString;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
