...
module.exports = class ImageTransform {
	 ...
	 * @param {String} uri - The URI to resolve. Must have one of the following schemes: fticon, ftlogo, ftsocial, ftpodcast, http, https, ftcms, ftbrand, specialisttitle.
						...
						case 'v1':
							{
								if (ftflag[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/ftflag/v1/${ftflag[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
			...
			case 'fticonold': 
				{
					switch (version) {
						case 'v4':
							{
								if (fticonold[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/fticonold/v4/${fticonold[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
			...
			case 'fticon':
				{
					switch (version) {
						case 'v1':
							{
								if (fticon[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/fticon/v1/${fticon[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
						...
						case 'v1':
							{
								if (ftlogo[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/ftlogo/v1/${ftlogo[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
						...
						case 'v2':
							{
								if (ftsocialV2[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/ftsocial/v2/${ftsocialV2[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
						...
						default:
							{
								if (ftsocial[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/ftsocial/v1/${ftsocial[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
						...
						case 'v1':
							{
								if (specialisttitle[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/specialisttitle/v1/${specialisttitle[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
						...
						case 'v1':
							{
								if (ftbrand[pathnameWithoutExtension]) {
									return `${baseUrl}/internal-images/ftbrand/v1/${ftbrand[pathnameWithoutExtension]}${queryString}`;
								} else {
									throw new Error(schemeErrorMessage);
								}
							}
