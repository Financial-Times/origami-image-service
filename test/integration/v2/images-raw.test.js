...
describe('GET /__origami/service/image/v2/images/raw…', function() {
	...
	describe('/http:/… (HTTP scheme url unencoded malformed)', function() {
		console.log(11, `/__origami/service/image/v2/images/raw/${testImageUris.httpmalformed}?source=origami-image-service`);
	...
	onlyRunOnExternalServer('/ftbrand:… (ftbrand scheme)', function() {
		console.log(`/__origami/service/image/v2/images/raw/${testImageUris.ftbrand}?source=origami-image-service`);
